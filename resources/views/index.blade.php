        ...
        <!-- <section class="about-area mb-9pt4">
            <div class="container p-5">
                <div class="row g-2  d-flex align-items-stretch">
                    ...
                    <div class="col-lg-6 col-md-12 p-2">
                        <div class="bg-black m-4 p-5 pb-0 mb-0 rounded h-100 d-flex flex-column justify-content-between">
                            <div>
                                ...
                                <a href="regsiter_procurement" class="btn btn-warning btn-lg mb-4">Register Here</a>
        ...
        <section>
            <div class="container">
                <div class="update-news ">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 mb-4 mb-4 mb-md-0">
                        ...
                        <div class="col-lg-6 col-md-12 mb-4 mb-sm-45 ">
                            <img src="assets/img/graph/3.png" alt="" class="img-fluid  mx-auto d-block">
                        </div>
                    </div>
        ...
        <section class="mb-5">
            <div class="container ">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 bg-black text-white  pt-5 pb-5 rounded m-5">
                        <div class="container ">
